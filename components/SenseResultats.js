  ...
  return (
    <View style={{alignItems: 'center', justifyContent: 'center', minHeight: 250}}>
      <TouchableOpacity>
        ...
        <Text style={{textAlign: 'center', fontFamily: 'mon-black', fontSize: 18}}> Ups! No hi ha cap resultat </Text>
        <Text style={{textAlign: 'center', fontFamily: 'mon-medium', fontSize: 16}}> Prova a canviar la cerca... o de Poble 🤷</Text>
      </TouchableOpacity>
    </View>
  );
}

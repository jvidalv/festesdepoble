    ...
    return (
        <View style={{alignItems: 'center', justifyContent: 'center', minHeight: 250}}>
            <TouchableOpacity
                ...
                <Text style={{textAlign: 'center', fontFamily: 'mon-black', fontSize: 18}}> S'ha produït un
                    error </Text>
                <Text style={{textAlign: 'center', fontFamily: 'mon-medium', fontSize: 16}}> Clica aquí per tornar-ho a
                    intentar </Text>
            </TouchableOpacity>
        </View>
    );
